...
var _class = function () {
    ...
    _class.prototype.setWebhook = function setWebhook(app, callback) {
        var _this = this;
    ...
    _class.prototype.handleMessages = function handleMessages(messages, sender) {
        var _this3 = this;
    ...
    _class.prototype.receivedMessageRead = function receivedMessageRead(event, callback) {
    ...
    _class.prototype.receivedDeliveryConfirmation = function receivedDeliveryConfirmation(event, callback) {
        var senderID = event.sender.id;
        var recipientID = event.recipient.id;
    ...
    _class.prototype.sendFileMessage = function sendFileMessage(recipientId, url, type) {
        var messageData = {
            recipient: {
                id: recipientId
            },
    ...
    _class.prototype.sendAccountLinking = function sendAccountLinking(recipientId, text, authUri) {
        var messageData = {
            recipient: {
                id: recipientId
            },
