...
var _class = function () {
    ...
    _class.prototype.start = function start(app, callback) {
        var _this = this;
    ...
    _class.prototype.setSession = function setSession(senderID) {
    ...
    _class.prototype.getSender = function getSender() {
        try {
    ...
    _class.prototype.handleResponse = function handleResponse(res, callback) {
        try {
            switch (res.origin) {
                case 'facebook':
                    {
    ...
    _class.prototype.handleFbEvent = function handleFbEvent(event, callback) {
    ...
    _class.prototype.handleDfResponse = function handleDfResponse(sender, response, callback) {
    ...
    _class.prototype.handleDfAction = function handleDfAction(sender, action, messages, contexts, parameters) {
    ...
    _class.prototype.handleDefault = function handleDefault(response) {
        try {
